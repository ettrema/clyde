...
public class HttpFileTransport implements FileTransport {
    ...
    @Override
    public void put(File f, File root) throws NotAuthorizedException, ConflictException, BadRequestException, IOException, FileNotFoundException, CancelledException {
