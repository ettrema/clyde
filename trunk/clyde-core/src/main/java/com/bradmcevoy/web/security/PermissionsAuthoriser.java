...
public class PermissionsAuthoriser implements ClydeAuthoriser, PropertyAuthoriser {
    ...
    private Role findRole(Resource resource, Method method) {
        if (resource instanceof Templatable) {
            boolean isEdit = isMethod(method, new Method[]{Method.PROPPATCH, Method.DELETE, Method.MOVE, Method.LOCK, Method.UNLOCK});
            boolean isCreate = isMethod(method, new Method[]{Method.COPY, Method.PUT, Method.MKCOL});
