...
public class Import extends AbstractConsoleCommand {
    ...
    private void doImport(com.ettrema.httpclient.Folder remoteFolder, CodeFolder localFolder, StringBuilder sb) throws IOException, HttpException, NotAuthorizedException, BadRequestException {
