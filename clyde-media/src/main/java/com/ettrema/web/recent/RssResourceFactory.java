 ...
 * 
 * Supports generating RSS files on demand for any folder, and also for generating
 * change logs (in a RSS similar format) for owner resources (ie users and webs)
 * 
 *
 */
