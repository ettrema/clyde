...
public class StatsResourceFactory extends CommonResourceFactory {
    ...
    private final ResourceFactory authResourceFactory;

    public StatsResourceFactory( ResourceFactory authResourceFactory, HostFinder hostFinder ) {
        super( hostFinder );
    ...
    public Resource getResource( String host, String url ) {
        if( authResourceFactory == null )
            throw new NullPointerException( "authResourceFactory is null" );
//        log.debug("getResource: host=" + host + " url=" + url);        
    ...
    public class StatsHost extends BaseStatsFolderResource {
        ...
        public Object authenticate( String user, String password ) {
            if( authResourceFactory == null )
                throw new NullPointerException( "resource fatory is null" );
            Host h = host();
