    ...
    public Resource getResource(String host, String url) throws NotAuthorizedException, BadRequestException {
        ...
        if (REDIRECT_TO_NEW_PATH.equals(path.getName())) {
            ...
            if (r == null) {
                ...
                Folder f = (Folder) r;
                try {
                    log.trace("found redirect to new page path");
            ...
            if (r == null) {
                ...
                if (r instanceof Folder) {
                    Folder f = (Folder) r;
                    try {
                        LogUtils.trace(log, "getResource: returning newPage for", pRes.getName());
                    ...
                    log.info("parent resource is not a folder, return error page");
