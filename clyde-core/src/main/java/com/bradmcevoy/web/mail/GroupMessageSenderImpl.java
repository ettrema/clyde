...
public class GroupMessageSenderImpl implements GroupMessageSender {
    ...
    @Override
    public String sendMessageToGroup(StandardMessage msg, MailboxAddress groupAddress, MailboxAddress from, Map<MailboxAddress,Object> mapOfMembers, MailSender mailSender, Templater templater) throws IllegalArgumentException, RuntimeException {
        StringBuffer sbSentTo = new StringBuffer();
        ...
        for (Map.Entry<MailboxAddress,Object> recipEntry : mapOfMembers.entrySet()) {
            MailboxAddress to = recipEntry.getKey();
            Object dataObject = recipEntry.getValue();
            try {
